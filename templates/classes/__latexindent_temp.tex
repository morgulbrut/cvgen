...
\documentclass[9pt]{classes/developercv} % Default font size, values from 8-12pt are recommended
...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{ Doe }}}}} % Last name
